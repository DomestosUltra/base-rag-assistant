...
class MessageHandler:
    ...
    async def _handle_start(self, message: Message) -> None:
        ...
        start_text = (
            ...
            "• /help — справка\n\n"
            "📎 Файлы форматов txt, md, csv, json, log, rst, docx сохраняются в базу знаний.\n"
            "💬 Просто отправь вопрос текстом, голосом, фото или документом."
        )
    ...
    async def _handle_help(self, message: Message) -> None:
        ...
        help_text = (
            ...
            "📎 Если отправить файл формата txt, md, csv, json, log, rst или docx,\n"
            "я сохраню его в базу знаний по текущим настройкам.\n\n"
